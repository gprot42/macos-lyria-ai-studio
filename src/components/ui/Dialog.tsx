...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        "fixed left-[50%] top-[50%] z-50 w-full max-w-lg translate-x-[-50%] translate-y-[-50%] border border-border bg-surface-elevated p-6 shadow-2xl rounded-xl animate-in fade-in-0 zoom-in-95",
        className
      )}
      {...props}
    >
